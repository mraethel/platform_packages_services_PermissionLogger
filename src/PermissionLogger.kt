...
const val MSG_LOG_APP_PERMISSION_FRAGMENT_ACTION_REPORTED = 0
const val MSG_READ_APP_PERMISSION_FRAGMENT_ACTION_REPORTED = 2
const val MSG_DEL_APP_PERMISSION_FRAGMENT_ACTION_REPORTED = 4

const val MSG_LOG_GRANT_PERMISSION_ACTIVITY_BUTTON_ACTIONS = 1
const val MSG_READ_GRANT_PERMISSION_ACTIVITY_BUTTON_ACTIONS = 3
const val MSG_DEL_GRANT_PERMISSION_ACTIVITY_BUTTON_ACTIONS = 5
  ...
  internal class IncomingHandler(
    ...
    override fun handleMessage(msg: Message) {
      ...
      when (msg.what) {
        ...
        MSG_DEL_APP_PERMISSION_FRAGMENT_ACTION_REPORTED -> appPermissionFragmentActionReportedDatabase.clearAllTables()
        
        MSG_DEL_GRANT_PERMISSION_ACTIVITY_BUTTON_ACTIONS -> grantPermissionActivityButtonActionsDatabase.clearAllTables()
      }
    }
  }
